 ...
 */
export class PsionicActionTypeFilter extends pf1.applications.compendiumBrowser.filters.CheckboxFilter {
 ...
 */
export class PsionicDisplayFilter extends pf1.applications.compendiumBrowser.filters.CheckboxFilter {
