# Available Foundry VTT Icons

This document lists all icons available in the Foundry VTT base installation that can be safely used by the pf1-psionics module scrapers.

**Last Updated:** November 01, 2025

**Generated by:** `tools/generate-icon-list.sh`

## Purpose

This reference helps developers and AI agents:
- Select icons that actually exist in Foundry VTT
- Avoid broken image references
- Find appropriate thematic icons for powers and feats
